    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#D8bfd8">
            ...
            <div class="collapse navbar-collapse" id="AdminMenu">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" style="color:white" href="CoordinatorElder.aspx"<strong>View Delivery </strong></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color:white" href="ViewVolunteers.aspx">View Volunteer </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color:white" href="ElderDetails.aspx">View Elder </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="color:white" href="Remarks.aspx">Remarks</a>
                    </li>
                </ul>
