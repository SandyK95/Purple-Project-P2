...
<!-- A grey navbar that expands horizontally at medium device -->
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#D8bfd8">
            ...
            <a class="navbar-brand" href="VolunteerMain.aspx" style="font-size: 32px; font-weight:bold; ">
                Volunteer
            </a></span><a class="navbar-brand" href="VolunteerMain.aspx" style="font-size: 32px; font-weight: bold; color: blueviolet;"></a>
            ...
            <div class="collapse navbar-collapse" id="VolunteerMenu">
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="ViewElder.aspx"><span class="auto-style2">View Elder Contact Details</span></a><span class="auto-style2"> </span>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Remark_Volunteer.aspx"><span class="auto-style2">Remarks to Volunteer</span></a>
                    </li>
                </ul>
